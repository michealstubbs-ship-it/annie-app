...
git add netlify\functions\lib\chatWebSearch.js
git add netlify\functions\download-invoice.js
git add src\lib\invoiceApi.js
git add src\components\Invoices.jsx
git add src\components\Chat.jsx
git add netlify\functions\tests\chat.test.js
git add netlify\functions\tests\download-invoice.test.js
echo (add - errorlevel %errorlevel%)
echo.

echo Committing the staged changes...
git commit -F commit-message-fresh-audit-2026-08-27.txt
if %errorlevel% neq 0 (
