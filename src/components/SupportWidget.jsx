...
Dashboard sections: Today's Actions (Annie's daily suggested BD tasks generated by AI), Intelligence Feed (BD triggers Annie has detected, like job moves, funding rounds, leadership changes, and expansions), Contacts (their BD contact list, with statuses hot/warm/cold/client/inactive), Companies (target company profiles and enrichment data), BD Pipeline (BD deals moving through stages with value and probability), Meetings (scheduled meetings tied to contacts and companies), Tasks (BD to-dos, separate from the AI-generated Today's Actions), Ask Annie (a BD assistant chat that drafts outreach, preps for calls, gives market intelligence). Recruitment-side firms also get Jobs & Mandates (open roles they're recruiting for) and Candidates (candidate profiles matched against those roles).

Settings lets them edit their profile and firm details, and re-run the LinkedIn import. Admin users additionally see an Insights page with aggregated support-conversation analytics; it's not visible to regular customers.
